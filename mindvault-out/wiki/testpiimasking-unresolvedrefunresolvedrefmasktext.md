# TestPIIMasking & __unresolved__::ref::__unresolved____ref__mask_text
...
- **TestPIIMasking** (uncounted-voice-api/tests/test_pii.py) -- 9 connections
  ...
  - <- contains <- [[testpii]]
- **__unresolved__::ref::__unresolved____ref__mask_text** () -- 7 connections
...
- **test_pii** (uncounted-voice-api/tests/test_pii.py) -- 2 connections
  - -> contains -> [[testpiimasking]]
  - -> imports -> [[unresolvedrefunresolvedrefpiiservice]]
- **test_card_number** (uncounted-voice-api/tests/test_pii.py) -- 2 connections
  - -> calls -> [[unresolvedrefunresolvedrefmasktext]]
  - <- contains <- [[testpiimasking]]
...
- **test_resident_number** (uncounted-voice-api/tests/test_pii.py) -- 2 connections
  - -> calls -> [[unresolvedrefunresolvedrefmasktext]]
  - <- contains <- [[testpiimasking]]
- **__unresolved__::ref::__unresolved____ref__pii_service** () -- 1 connections
  - <- imports <- [[testpii]]
...
- test_pii -> imports -> __unresolved__::ref::__unresolved____ref__pii_service [EXTRACTED]
- test_card_number -> calls -> __unresolved__::ref::__unresolved____ref__mask_text [EXTRACTED]
- test_email -> calls -> __unresolved__::ref::__unresolved____ref__mask_text [EXTRACTED]
- test_exclude_common_words -> calls -> __unresolved__::ref::__unresolved____ref__mask_text [EXTRACTED]
- test_name_masking_disabled -> calls -> __unresolved__::ref::__unresolved____ref__mask_text [EXTRACTED]
- test_name_masking_enabled -> calls -> __unresolved__::ref::__unresolved____ref__mask_text [EXTRACTED]
- test_phone_number -> calls -> __unresolved__::ref::__unresolved____ref__mask_text [EXTRACTED]
- test_resident_number -> calls -> __unresolved__::ref::__unresolved____ref__mask_text [EXTRACTED]
- test_segments_masking -> calls -> __unresolved__::ref::__unresolved____ref__mask_segments [EXTRACTED]

## Cross-Community Connections
- test_segments_masking -> calls -> __unresolved__::ref::__unresolved____ref__len (-> [[unresolvedrefunresolvedrefpush-unresolvedrefunresolvedreflen]])

## Context
이 커뮤니티는 TestPIIMasking, __unresolved__::ref::__unresolved____ref__mask_text, test_segments_masking를 중심으로 contains 관계로 연결되어 있다. 주요 소스 파일은 test_pii.py이다.
