...
- ensureListeners -> calls -> __unresolved__::ref::addeventlistener (-> [[unresolvedrefpush-testparseinstinct]])
- ensureListeners -> calls -> __unresolved__::ref::addeventlistener (-> [[unresolvedrefpush-testparseinstinct]])

## Context
이 커뮤니티는 __unresolved__::ref::cb, network, network를 중심으로 contains 관계로 연결되어 있다. 주요 소스 파일은 network.ts이다.
