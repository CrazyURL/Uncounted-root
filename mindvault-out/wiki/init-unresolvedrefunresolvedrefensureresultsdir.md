# __init__ & __unresolved__::ref::__unresolved____ref___ensure_results_dir
...
## Context
이 커뮤니티는 __init__, __unresolved__::ref::__unresolved____ref___ensure_results_dir, __unresolved__::ref::__unresolved____ref__lock를 중심으로 calls 관계로 연결되어 있다. 주요 소스 파일은 job_store.py이다.
