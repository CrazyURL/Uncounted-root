...
- **Python Hooks** (.claude/rules/python/hooks.md) -- 4 connections
  - -> references -> [[unresolvedrefunresolvedrefunresolvedrefunresolvedrefunresolvedrefunresolvedrefhooks]]
...
- **TypeScript/JavaScript Hooks** (.claude/rules/typescript/hooks.md) -- 4 connections
  ...
  - -> contains -> [[stop-hooks]]
  - <- contains <- [[hooks]]
- **__unresolved__::ref::__unresolved____ref____unresolved____ref____unresolved____ref____unresolved____ref____unresolved____ref__hooks** () -- 3 connections
...
- Java Hooks -> references -> __unresolved__::ref::__unresolved____ref____unresolved____ref____unresolved____ref____unresolved____ref____unresolved____ref__hooks [EXTRACTED]
- Java Hooks -> contains -> PostToolUse Hooks [EXTRACTED]
- hooks -> contains -> Python Hooks [EXTRACTED]
- Python Hooks -> references -> __unresolved__::ref::__unresolved____ref____unresolved____ref____unresolved____ref____unresolved____ref____unresolved____ref__hooks [EXTRACTED]
...
- TypeScript/JavaScript Hooks -> references -> __unresolved__::ref::__unresolved____ref____unresolved____ref____unresolved____ref____unresolved____ref____unresolved____ref__hooks [EXTRACTED]
...
## Context
이 커뮤니티는 Python Hooks, TypeScript/JavaScript Hooks, __unresolved__::ref::__unresolved____ref____unresolved____ref____unresolved____ref____unresolved____ref____unresolved____ref__hooks를 중심으로 contains 관계로 연결되어 있다. 주요 소스 파일은 hooks.md이다.
