...
- Key Findings -> references -> __unresolved__::ref::__unresolved____ref____unresolved____ref____unresolved____ref__app (-> [[sttprocessor-denoise]])
- Sources -> references -> __unresolved__::ref::__unresolved____ref____unresolved____ref____unresolved____ref__app (-> [[sttprocessor-denoise]])

## Context
이 커뮤니티는 Sources, Key Findings, __unresolved__::ref::__unresolved____ref____unresolved____ref____unresolved____ref__autoscanevent를 중심으로 references 관계로 연결되어 있다. 주요 소스 파일은 codex.md이다.
