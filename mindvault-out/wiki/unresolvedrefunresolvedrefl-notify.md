# __unresolved__::ref::__unresolved____ref__l & notify
...
## Context
이 커뮤니티는 __unresolved__::ref::__unresolved____ref__l, notify, notify를 중심으로 calls 관계로 연결되어 있다. 주요 소스 파일은 pipelineState.ts, sharePrepStore.ts, verificationEngine.ts이다.
