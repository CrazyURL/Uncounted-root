...
- **Java Coding Style** (.claude/rules/java/coding-style.md) -- 10 connections
  - -> references -> [[unresolvedrefunresolvedrefcodingstyle]]
  - -> contains -> [[formatting]]
...
- **java** (.claude/rules/java/coding-style.md) -- 4 connections
  ...
  - <- has_code_example <- [[error-handling]]
- **__unresolved__::ref::__unresolved____ref__coding_style** () -- 3 connections
...
- Java Coding Style -> references -> __unresolved__::ref::__unresolved____ref__coding_style [EXTRACTED]
...
- Python Coding Style -> references -> __unresolved__::ref::__unresolved____ref__coding_style [EXTRACTED]
...
- TypeScript/JavaScript Coding Style -> references -> __unresolved__::ref::__unresolved____ref__coding_style [EXTRACTED]
