...
## Key Nodes
- **화자분리 (Speaker Diarization) 개선 히스토리 — 서버 사이드 WhisperX + pyannote** (uncounted-docs/voice-api/화자분리_개선_히스토리.md) -- 6 connections
...
- **2026-04-12 — utterance_segmenter Case C 과병합 버그 (수정 완료)** (uncounted-docs/voice-api/화자분리_개선_히스토리.md) -- 4 connections
  - -> contains -> [[utterancesegmenterpymergeshortutterances-case-c]]
  - -> contains -> [[88]]
  - -> contains -> [[pyannote]]
  - <- contains <- [[speaker-diarization-whisperx-pyannote]]
- **python** (uncounted-docs/voice-api/화자분리_개선_히스토리.md) -- 2 connections
...
- **2026-04-12 — 전처리 재적용 Round 1 검증 중 발견된 경계 오류** (uncounted-docs/voice-api/화자분리_개선_히스토리.md) -- 2 connections
  - -> contains -> [[gain]]
  - <- contains <- [[speaker-diarization-whisperx-pyannote]]
- **실증 분석 (88 토큰 샘플)** (uncounted-docs/voice-api/화자분리_개선_히스토리.md) -- 2 connections
  - -> has_code_example -> [[python]]
  - <- contains <- [[2026-04-12-utterancesegmenter-case-c]]
- **근본 원인 — `utterance_segmenter.py:_merge_short_utterances` Case C** (uncounted-docs/voice-api/화자분리_개선_히스토리.md) -- 2 connections
  - -> has_code_example -> [[python]]
  - <- contains <- [[2026-04-12-utterancesegmenter-case-c]]
...
- **gain 정규화 무관함 (기록용)** (uncounted-docs/voice-api/화자분리_개선_히스토리.md) -- 1 connections
  - <- contains <- [[2026-04-12-round-1]]
- **pyannote 경계 오류와의 관계** (uncounted-docs/voice-api/화자분리_개선_히스토리.md) -- 1 connections
  - <- contains <- [[2026-04-12-utterancesegmenter-case-c]]
