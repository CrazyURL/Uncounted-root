...
- **Pull Request Workflow** (.claude/rules/common/git-workflow.md) -- 2 connections
  - -> references -> [[unresolvedrefdevelopmentworkflow]]
  - <- contains <- [[git-workflow]]
- **__unresolved__::ref::development_workflow** () -- 1 connections
...
- Pull Request Workflow -> references -> __unresolved__::ref::development_workflow [EXTRACTED]

## Cross-Community Connections

## Context
이 커뮤니티는 Git Workflow, Pull Request Workflow, __unresolved__::ref::development_workflow를 중심으로 contains 관계로 연결되어 있다. 주요 소스 파일은 git-workflow.md이다.
