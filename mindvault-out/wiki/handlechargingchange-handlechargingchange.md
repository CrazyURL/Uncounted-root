...
- **handleChargingChange** (uncounted-app/src/lib/batteryCollector.ts) -- 8 connections
  ...
  - -> calls -> [[unresolvedrefclassifyduration]]
  - <- contains <- [[batterycollector]]
- **__unresolved__::ref::classifyduration** () -- 3 connections
...
## Context
이 커뮤니티는 handleChargingChange, handleChargingChange, __unresolved__::ref::classifyduration를 중심으로 calls 관계로 연결되어 있다. 주요 소스 파일은 batteryCollector.ts이다.
