...
- **__unresolved__::ref::__unresolved____ref__classifychargingspeed** () -- 2 connections
  - <- calls <- [[handlechargingchange]]
  - <- calls <- [[handlechargingchange]]
- **__unresolved__::ref::__unresolved____ref__classifyduration** () -- 2 connections
  - <- calls <- [[handlechargingchange]]
  - <- calls <- [[handlechargingchange]]
...
## Context
이 커뮤니티는 handleChargingChange, handleChargingChange, __unresolved__::ref::__unresolved____ref__appendrecord를 중심으로 calls 관계로 연결되어 있다. 주요 소스 파일은 batteryCollector.ts이다.
